...
clojure.browser.event.IEventType = (function (){var obj12593 = {};
return obj12593;
})();
...
return (function (){var or__4020__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4664__auto__)]);
if(or__4020__auto__){
...
var this$__$1 = this;
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,((function (this$__$1){
return (function (p__12596){
var vec__12597 = p__12596;
var k = cljs.core.nth.call(null,vec__12597,(0),null);
var v = cljs.core.nth.call(null,vec__12597,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
